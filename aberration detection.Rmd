...
Import the data provided with the surveillance packae
```{r}
...
Combine together cases data and a vector of time points
```{r}
...
salmonellaDisProg <- create.disProg(
      ...
      start = c(1990, 1)) #start date; 1st week of 1990
